...
def ai_decision(df, stop_loss_percent=STOP_LOSS_PERCENT, take_profit_percent=TAKE_PROFIT_PERCENT, position=None, buy_price=None):
    ...
    if position == "long" and buy_price is not None:
        ...
        if close_price <= stop_loss:
            ...
            action = "sell"
        elif (lst_diff < - 7.00 and kdj_j > 75.00): # and kdj_j > kdj_d 
            logger.info("Sell-logic triggered.")
            action = "sell"
            ...
            action = "sell"
        elif (close_price < ema1 or macd < macd_signal):# and kdj_j > kdj_d and macd > macd_signal and ema1 > ema2 and kdj_j > 58): #or (kdj_j < kdj_d and macd < macd_signal and close_price < open_price and kdj_j > 15): # or (close_price < open_price and kdj_j < kdj_d and macd > macd_signal):
