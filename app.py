...
def ai_decision(df, stop_loss_percent=STOP_LOSS_PERCENT, take_profit_percent=TAKE_PROFIT_PERCENT, position=None, buy_price=None):
    ...
    if position == "long" and buy_price is not None:
        ...
        if close_price <= stop_loss:
            ...
            logger.info(f"Sell condition met: close={close_price:.2f}, open={open_price:.2f}, kdj_j={kdj_j:.2f}, kdj_d={kdj_d:.2f}, DIF={macd:.2f}, DEA={macd_signal:.2f}")
            action = "sell"
        elif (close_price < open_price and kdj_j < kdj_d and macd > macd_signal and kdj_j > 40):
            logger.info(f"Sell condition met: close={close_price:.2f}, open={open_price:.2f}, kdj_j={kdj_j:.2f}, kdj_d={kdj_d:.2f}, DIF={macd:.2f}, DEA={macd_signal:.2f}")
            action = "sell"
        elif (close_price < open_price and kdj_j > kdj_d and macd < macd_signal and kdj_j > 45):
            logger.info(f"Sell condition met: close={close_price:.2f}, open={open_price:.2f}, kdj_j={kdj_j:.2f}, kdj_d={kdj_d:.2f}, DIF={macd:.2f}, DEA={macd_signal:.2f}")
            action = "sell"
        elif kdj_j > 133.00:
    ...
    if action == "hold" and position is None:
        if (kdj_j < -30.00 and ema1 < ema2 or kdj_j < kdj_d and macd < macd_signal): # or (close_price > open_price and kdj_j > kdj_d or ema1 > ema2 and macd > macd_signal):
